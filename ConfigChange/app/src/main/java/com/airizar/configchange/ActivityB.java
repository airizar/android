package com.airizar.configchange;
...
public class ActivityB extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpenA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("CHANGE","Open Activity A from B");
                //se crea la intencion de hacer algo
                //aqui el this hace referencia al listener
                //ActivityA.this: me devuelve la instancia de la actividad A
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("CHANGE","Close B Activity");

               //hace lo mismo que el volver : Stop y Destroy
                finish();
            }
        });
    ...
    //stop y stop se paran servicios,..
    @Override
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Log.d("CHANGE","Activity B onSaveInstanceState()");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.d("CHANGE","Activity B onRestoreInstanceState()");
        super.onRestoreInstanceState(savedInstanceState);
        this.restoreState(savedInstanceState);
    }
    private void restoreState(Bundle savedInstaceState){
        this.data=savedInstaceState.getString("data");
    }
