...
public class ActivityA extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //la actividad se carga justo despues del setContentView
        setContentView(R.layout.activity_a);
        //obtenemos referencias de los elementos, en este caso los botones
        Button btnOpenB= (Button) findViewById(R.id.btnOpenB);
        //addEventListener
        btnOpenB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("CHANGE","Open Activity B from A");
